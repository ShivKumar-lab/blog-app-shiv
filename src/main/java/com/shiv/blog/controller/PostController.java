...
public class PostController {
    ...
    public String showBlogPost(@PathVariable(value = "postId") Long postId, Model model) {
        ...
        Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        String username, allowForPost, allowForComment;
        if (principal instanceof UserDetails) {
            username = ((UserDetails)principal).getUsername();
        } else {
            username = principal.toString();
    ...
    public String processFilters(@ModelAttribute TagFilterOptions tagFilterOptions, Model model, String dateFrom, String dateTo) {
